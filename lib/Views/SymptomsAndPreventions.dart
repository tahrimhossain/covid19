  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: [
              ...
              Card(
                ...
                child: Padding(
                  padding: EdgeInsets.symmetric(
                    horizontal: 20,
                    vertical: (10 / 812) * MediaQuery.of(context).size.height,
                  ),
                  child: Column(
                    ...
                    children: [
                      Center(
                        child: Container(
                          height:
                              (90 / 812) * MediaQuery.of(context).size.height,
                          child: Image.asset(
                            "images/fever.png",
                            fit: BoxFit.fitWidth,
                          ),
        ...
        Padding(
          padding: EdgeInsets.only(
            left: (12 / 375) * MediaQuery.of(context).size.width,
          ),
                      ...
                      children: <Widget>[
                        Padding(
                          ...
                          child: SizedBox(
                            ...
                            width:
                                (60 / 375) * MediaQuery.of(context).size.width,
                        ...
                        SizedBox(
                          height:
                              (120 / 812) * MediaQuery.of(context).size.height,
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: <Widget>[
                        ...
                        SizedBox(
                          width:
                              (10 / 812) * MediaQuery.of(context).size.height,
                        ),
                      ],
                    ),
                  ),
